                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <div>
                                <form method="POST"class="d-flex" action="{{ route('logout') }}">
                                    ...
                                    @csrf
                                    <button type="submit" class="dropdown-item has-icon text-danger" style="outline: none; border:none;">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="dropdown active">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="nav-link" href="{{ route('admin_categories.index') }}">Category</a>
                                </li>
